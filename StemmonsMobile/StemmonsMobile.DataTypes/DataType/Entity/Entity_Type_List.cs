...
public partial class EXTERNAL_DATASOURCE_DATA
{
    ...
    private List<EXTERNAL_DATASOURCE_DATAEXTERNAL_DATASOURCE> eXTERNAL_DATASOURCEField;

    /// <remarks/>
    [System.Xml.Serialization.XmlElementAttribute("EXTERNAL_DATASOURCE")]
    public List<EXTERNAL_DATASOURCE_DATAEXTERNAL_DATASOURCE> EXTERNAL_DATASOURCE
    {
        get
        {
...
public partial class EXTERNAL_DATASOURCE_DATAEXTERNAL_DATASOURCE
{
    ...
    private List<EXTERNAL_DATASOURCE_DATAEXTERNAL_DATASOURCEEXTERNAL_DATASOURCE_OBJECT> eXTERNAL_DATASOURCE_OBJECTField;
    ...
    public List<EXTERNAL_DATASOURCE_DATAEXTERNAL_DATASOURCEEXTERNAL_DATASOURCE_OBJECT> EXTERNAL_DATASOURCE_OBJECT
    {
        get
        {
