...
{
    public class GetItemInstanceTranResponse : Response
    {
        ...
        public class ItemInstanceTran
        {
            ...
            {
                get { return this.GetType().GetRuntimeProperty(propertyName).GetValue(this, null); }
                set { this.GetType().GetRuntimeProperty(propertyName).SetValue(this, value, null); }
            }
        }
    }
}