...
{
    public partial class GetCaseTypesResponse : Response
    {
        ...
        public class BasicCase
        {
            ...
            public string DueDate
            {
                get
                {
                    if (!string.IsNullOrEmpty(this.strCaseDue))
                    {
                        return $"{"DueDate : "}{strCaseDue}";
                    }
                    else
                    {
                        return string.Empty;
...
//                    return $"{"DueDate : "}{CaseDue}";
//                    //if (!string.IsNullOrEmpty(this.CaseDue))
//                    //{
...
//                    if (!string.IsNullOrEmpty(this.CaseAssignDateTimeDateOnly))
//                    {
//                        return $"{"Assigned On : "}{CaseAssignDateTimeDateOnly}";
//                    }
//                    else
//                    {
//                        return string.Empty;
