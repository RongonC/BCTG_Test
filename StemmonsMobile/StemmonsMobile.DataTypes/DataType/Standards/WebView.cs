...
namespace StemmonsMobile.DataTypes.DataType.Standards
{
   ...
   // [System.SerializableAttribute()]
    ...
    {
        public standardsWebView WebDeserialize()
        {
            standardsWebView standardsWebView = new standardsWebView()
            {

                Web_View = new List<STANDARDSWEB_VIEW>()

            };

            if (this.WEB_VIEW != null)
            {
                foreach (var item in this.WEB_VIEW)
                {
                    standardsWebView.Web_View.Add(new STANDARDSWEB_VIEW()
                    {
                        ...
                        hAS_DETAILSField = item.HAS_DETAILS,
                    });
                }
            }
            return standardsWebView;
        }



        private STANDARDSWEB_VIEW[] wEB_VIEWField;

        /// <remarks/>
        [System.Xml.Serialization.XmlElementAttribute("WEB_VIEW")]
        public STANDARDSWEB_VIEW[] WEB_VIEW
        {
            get
            {
                return this.wEB_VIEWField;
            }
            set
            {
                this.wEB_VIEWField = value;
            }
        }
    }
  ...
  //  [System.SerializableAttribute()]
   // [System.ComponentModel.DesignerCategoryAttribute("code")]
    [System.Xml.Serialization.XmlTypeAttribute(AnonymousType = true)]
    public partial class STANDARDSWEB_VIEW
    {
        ...
        public string HAS_DETAILS
        {
            get
            {
                return this.hAS_DETAILSField;
            }
            set
            {
                this.hAS_DETAILSField = value;
            }
        }
    }
