...
namespace StemmonsMobile.Views.Standards.TreeView
{
    public partial class TreeViewItem : StackLayout, IDisposable
    {
        ...
        /// </summary>
        private readonly Button _ExpandButton = new Button
        {
            Image = "Assets/dropdowniconClose.png",
            HeightRequest = 40,
            WidthRequest = 40,
        ...
        public bool IsExpanded
        {
            ...
            set
            {
                ...
                _ExpandButton.Image = value ? "Assets/dropdownicon.png" : "Assets/dropdowniconClose.png";
            }
        }
        ...
        public TreeViewItem()
        {
            ...
            _HeaderView.GestureRecognizers.Add(_TapGestureRecognizer);
